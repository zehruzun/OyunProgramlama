...
public class CollectableSpawnArea : MonoBehaviour
{
    ...
    private void Spawn()
    {
        float minX = -_spawnRadius; // kare alanýn sol çaprazý
        float maxX = _spawnRadius; // kare alanýn sað çaprazý
        float minZ = -_spawnRadius; // kare alanýn alt çaprazý
        float maxZ = _spawnRadius; // kare alanýn üst çaprazý

        // kare alanýn içinde rastgele bir nokta üret
